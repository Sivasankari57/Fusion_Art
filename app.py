...
# Fuzzy rules
rule1 = ctrl.Rule(texture_similarity['poor'] & color_similarity['poor'], fusion_weight['high'])  # Favor TCP
rule2 = ctrl.Rule(texture_similarity['average'] & color_similarity['average'], fusion_weight['medium'])  # Balanced
rule3 = ctrl.Rule(texture_similarity['good'] & color_similarity['good'], fusion_weight['low'])  # Favor AI
...
if __name__ == "__main__":
    tcp_path = "input_images/tcp.jpg"     # Traditional Chinese Painting
    ai_path = "input_images/ai.jpg"       # AI Generated Painting
