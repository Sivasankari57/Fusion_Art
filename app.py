...
import os
if os.path.exists(r"/content/drive/My Drive/Colab Notebooks/Extracted_Dataset/preprocessed_Chinese_Landscape_Painting2photo/testA"):
    files = os.listdir(r"/content/drive/My Drive/Colab Notebooks/Extracted_Dataset/preprocessed_Chinese_Landscape_Painting2photo/testA")
    print("Files in directory:", files)
else:
    print("Directory not found: /content/drive/My Drive/Colab Notebooks/Extracted_Dataset/preprocessed_Chinese_Landscape_Painting2photo/testA")
import os
if os.path.exists(r"/content/drive/My Drive/Colab Notebooks/Extracted_Dataset/preprocessed_Chinese_Landscape_Painting2photo/testB"):
    files = os.listdir(r"/content/drive/My Drive/Colab Notebooks/Extracted_Dataset/preprocessed_Chinese_Landscape_Painting2photo/testB")
    print("Files in directory:", files)
else:
    print("Directory not found: /content/drive/My Drive/Colab Notebooks/Extracted_Dataset/preprocessed_Chinese_Landscape_Painting2photo/testB")
...
import os
if os.path.exists(r"/content/drive/My Drive/Colab Notebooks/Extracted_Dataset"):
    files = os.listdir(r"/content/drive/My Drive/Colab Notebooks/Extracted_Dataset")
    print("Files in directory:", files)
else:
    print("Directory not found: /content/drive/My Drive/Colab Notebooks/Extracted_Dataset")


import os
if os.path.exists(r"/content/drive/My Drive/Colab Notebooks/Extracted_Dataset/1to1_phash_matched"):
    files = os.listdir(r"/content/drive/My Drive/Colab Notebooks/Extracted_Dataset/1to1_phash_matched")
    print("Files in directory:", files)
else:
    print("Directory not found: /content/drive/My Drive/Colab Notebooks/Extracted_Dataset/1to1_phash_matched")
